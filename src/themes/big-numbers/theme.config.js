...
module.exports = {
  ...
  variants: [
    {
      name: "With TCG art as a background",
      params: { horizontal: false, flipped: false, useCardArtBackground: true },
    },
    {
      name: "With a background gradient derived from typings",
      params: { horizontal: false, flipped: false, useTypesGradient: true },
    },
    {
      name: "With TCG art, and the gradient overlayed",
      params: {
        horizontal: false,
        flipped: false,
        useCardArtBackground: true,
        useTypesGradient: true,
      },
    },
  ],
  settings: {
    theme: {
      name: "big-numbers",
      horizontal: getParam("horizontal") === "true",
      pokemonTCGCardSets: function () {
        let userDefinedSets = getParam("sets");
    ...
    pokeImg: {
      ...
      fileType: "png",
      ignoreForms: false,
      useCardArtBackground: getParam("useCardArtBackground") === "true",
      useTypesGradient: getParam("useTypesGradient") === "true",
    },
    ...
    imgPaths: {
      ...
      normal:
        "https://assets.pokelink.xyz/assets/sprites/pokemon/heartgold-soulsilver/normal/",
      shiny:
        "https://assets.pokelink.xyz/assets/sprites/pokemon/heartgold-soulsilver/shiny/",
